...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      'process.env.KIMI_API_KEY': JSON.stringify(env.KIMI_API_KEY || "sk-BsKf5zSpyX2AzufOl3b8uyh5JMps6aOKzlNeN1tWxAf41vH0"),
      ...
      'process.env': JSON.stringify({
        ...
        KIMI_API_KEY: env.KIMI_API_KEY || "sk-BsKf5zSpyX2AzufOl3b8uyh5JMps6aOKzlNeN1tWxAf41vH0",
